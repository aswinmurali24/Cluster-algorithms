...
def plot_silhouette(k_values, silhouette_scores):
    ...
    plt.title('Silhouette coefficient for K means algorithm') 
...
def main():
    ...
    for k in k_values:
        centroids, cluster_ids = kmeans(dataset, k) 
